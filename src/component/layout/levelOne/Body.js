        ...
        <>
            <div className="top-header">
                ...
                <div className="menu-hide">
                    ...
                    <a href="https://localhost:3000/logout"><p>Deconnexion</p></a>
                </div>
            </div>
            <main>
                <div className="main-two-cols">
                    <div className="sidebar">
                        <div className="sidebar-item">
                            ...
                            <div>
                                <a href="https://localhost/artistes">
                                    <p>artistes</p>
                                </a>
                            </div>
                        </div>
                        <div className="sidebar-item">
                            ...
                            <div>
                                <a href="https://localhost/activites">
                                    <p>activites</p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="sidebar-item">
                            ...
                            <div>
                                <a href="https://localhost/commerces">
                                    <p>commerces</p>
                                </a>
                            </div>
                        </div>
                        <div className="sidebar-item">
                            ...
                            <div>
                                <a href="https://localhost/utilisateurs">
                                    <p>utilisateurs</p>
                                </a>
                            </div>
                        </div>
